  ...
  return(
      <div>
          <div className="container">
              <h2 className='text-center mb-5'> Why choose the University of London ?</h2>
                      ...
                      h-100'>
                          ...
                          <Card.Body>
                              ...
                              <Card.Text className='text-center'>
                                  ...
                                  Quam voluptatibus esse tempore, nihil temporibus libero vitae 
                                  commodi quos molestias voluptatem.
                              </Card.Text>
                          </Card.Body>
                      </Card>
                  </div>
