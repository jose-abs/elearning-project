    ...
    <div className='contact-page'>
          <header className='height-75'>
                ...
                justify-content-center text-light'>
                    ...
                    <p className='text-center w-75 mb-5'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ratione ab 
                      iste possimus magnam corporis blanditiis esse dignissimos harum, inventore debitis.</p>
          ...
          <div className='container my-5 d-flex justify-content-center'>
                <Form id='contact-form'>
                      ...
                      <Form.Group className='mb-3'>
                            ...
                            <Form.Control placeholder='Your address'></Form.Control>
                      </Form.Group>
